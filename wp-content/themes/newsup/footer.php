                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6 text-xs">
								...
								printf( esc_html__( 'Proudly powered by %s', 'newsup' ), 'An Engineer Factez' );
								?>
								</a>
								<span class="sep"> | </span>
								<?php
								/* translators: placeholder replaced with string */
								printf( esc_html__( 'Theme: %1$s by %2$s.', 'newsup' ), 'Designed', '<a href="' . esc_url( __( '#', '' ) ) . '" rel="designer">Ghanshyam Bind</a>' );
								?>
								</p>
                            </div>
